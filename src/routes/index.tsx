    ...
    <section className="cyber-grid" style={{ padding: 'clamp(72px, 10vw, 120px) 16px 80px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
        <div className="badge badge-cyan" style={{ margin: '0 auto 24px', display: 'inline-flex' }}>
          <span>✦</span>
          <span>Premium AI Resource Pack</span>
        </div>
        ...
        <h1 style={{
          ...
          Unlock The Complete{' '}
          <span className="gradient-text">AI Developer Resource Pack</span>
        </h1>
        ...
        <p style={{
          ...
          Get organized AI coding tools, official links, setup commands, prompts, checklists,
          video references, and launch templates in one premium pack.
        </p>
...
function WhatsInsideSection() {
  const categories = [
    { icon: '🤖', title: 'AI Coding Tools', desc: 'Top AI assistants with setup notes and comparisons', color: '#00d4ff' },
    { icon: '🔷', title: 'Claude Code & Alternatives', desc: 'Claude, Cline, Continue, and more compared', color: '#8b5cf6' },
    { icon: '🌐', title: 'OpenCode / OpenRouter / Kiro', desc: 'Open model access and routing platforms', color: '#10b981' },
    { icon: '🐙', title: 'GitHub & Copilot', desc: 'Student pack guide and Copilot setup tips', color: '#00d4ff' },
    { icon: '🧩', title: 'VS Code AI Extensions', desc: 'Best extensions with install commands', color: '#f59e0b' },
    { icon: '🌍', title: 'Website Building', desc: 'Frameworks, templates, and deployment guides', color: '#8b5cf6' },
    { icon: '📈', title: 'SEO & Monetization', desc: 'AdSense, SEO tools, and micro-income strategies', color: '#10b981' },
    { icon: '💬', title: 'Prompt Templates', desc: 'Ready-to-use AI prompts for common tasks', color: '#00d4ff' },
    { icon: '⚡', title: 'Setup Commands', desc: 'Copy-paste terminal commands for quick setup', color: '#f59e0b' },
    { icon: '✅', title: 'Checklists & Downloads', desc: 'Launch checklists and downloadable ZIP files', color: '#8b5cf6' },
  ]
...
const PREVIEW_RESOURCES = [
  ...
  { title: 'SEO + AdSense Micro Tool Plan', summary: 'Minimal viable content strategy to get AdSense approved on a new developer blog.', category: 'SEO & Monetization', link: '/checkout', linkLabel: 'Original Notes' },
  { title: 'AI Prompt Library', summary: '30+ reusable prompts for coding, debugging, writing docs, and generating components.', category: 'Prompt Templates', link: '/checkout', linkLabel: 'Original Content' },
  { title: 'Full Resource Links Database', summary: '100+ verified and categorized links to official AI tools, docs, and video references.', category: 'All Categories', link: '/checkout', linkLabel: 'Included in Pack' },
]
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
          {PREVIEW_RESOURCES.map(res => (
            <div key={res.title} className="card-glow" style={{ borderRadius: '12px', padding: '24px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(0,212,255,0.1)', paddingTop: '12px' }}>
                <a
                  href={res.link}
                  target={res.link.startsWith('http') ? '_blank' : undefined}
                  rel="noopener noreferrer"
                  style={{ color: '#00d4ff', fontSize: '0.8rem', textDecoration: 'none' }}
                >
                  {res.linkLabel} ↗
                </a>
    ...
    <section id="pricing" style={{ background: '#080c14', padding: '96px 16px' }}>
      <div style={{ maxWidth: '520px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <div className="badge badge-green" style={{ display: 'inline-flex', marginBottom: '16px' }}>Most Popular</div>

          <h3 style={{ color: '#f1f5f9', fontSize: '1.5rem', fontWeight: 800, margin: '0 0 8px' }}>AI Developer Resource Pack</h3>
          <p style={{ color: '#64748b', marginBottom: '28px' }}>Complete lifetime access to all resources</p>

          <div style={{ marginBottom: '28px' }}>
            <span style={{ fontSize: '3rem', fontWeight: 900, color: '#00d4ff' }}>₹499</span>
            <span style={{ color: '#475569', marginLeft: '8px' }}>/ $9 USD</span>
          </div>
    ...
    <section style={{ background: '#050810', padding: '96px 16px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ background: '#111827', borderBottom: '1px solid rgba(0,212,255,0.1)', padding: '12px 16px', display: 'flex', gap: '8px', alignItems: 'center' }}>
            <div style={{ width: 12, height: 12, borderRadius: '50%', background: '#ef4444' }} />
            <div style={{ width: 12, height: 12, borderRadius: '50%', background: '#f59e0b' }} />
            <div style={{ width: 12, height: 12, borderRadius: '50%', background: '#10b981' }} />
            <div style={{ flex: 1, background: '#1e293b', borderRadius: '6px', padding: '4px 12px', marginLeft: '8px' }}>
              <span style={{ color: '#475569', fontSize: '0.75rem' }}>devpackai.com/dashboard</span>
            </div>
          ...
          <div style={{ padding: '32px', position: 'relative' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '12px', marginBottom: '0' }}>
              {sections.map(s => (
                <div key={s.title} style={{ background: '#111827', border: '1px solid rgba(0,212,255,0.1)', borderRadius: '10px', padding: '18px' }}>
...
const FAQ_ITEMS = [
  ...
  { q: 'Are these resources original?', a: 'The pack includes a mix: original notes, checklists, and prompt templates created for this pack, plus curated links to official third-party tools and documentation. All external links are clearly labeled as Official Tool, Documentation, or Reference Tutorial.' },
    ...
    <section id="faq" style={{ background: '#080c14', padding: '96px 16px' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {FAQ_ITEMS.map(item => (
            <details key={item.q} style={{ background: '#0d1117', border: '1px solid rgba(0,212,255,0.12)', borderRadius: '10px', overflow: 'hidden' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '48px', padding: '32px', background: '#0d1117', border: '1px solid rgba(0,212,255,0.15)', borderRadius: '16px' }}>
